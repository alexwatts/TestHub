...
There is a jenkins job that is doing that into a staging for the UI and backend [Here](http://138.68.170.14:30000/) It's named TestHub-pipeline. Access with below Credentials.
