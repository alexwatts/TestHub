...
There is a staging version of the UI and backend deployed [Here](http://209.97.191.101:30001/)
...
There is a jenkins job that is doing that into a staging for the UI and backend [Here](http://209.97.191.101:30000/) It's named TestHub-pipeline. Access with below Credentials.
